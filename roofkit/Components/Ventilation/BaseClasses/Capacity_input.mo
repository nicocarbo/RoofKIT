...
model Capacity_input "Capacity, Lumped thermal element storing heat"

  parameter Boolean steadyStateStart=false
    "true, if component shall start in steady state";
  Modelica.SIunits.Temperature T(start=
        Modelica.SIunits.Conversions.from_degC(20)) "Temperature of part";
...
<ul>
<li>
August 22, 2018, by Nicolas Carbonare:<br/>
