...
It discharges provided that it is being consumed and the PV system is not generating power. It remains discharging until it is empty or the PV system begins to generate more power. The controller was adapted for an optimized charging behavior during the SDE 21/22 competition. 
</p>
</html>", revisions = "<html>
<ul>
<li>
