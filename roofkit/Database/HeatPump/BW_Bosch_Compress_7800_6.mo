...
record BW_Bosch_Compress_7800_6 = Buildings.Fluid.HeatPumps.Data.EquationFitReversible.Generic(dpHeaSou_nominal = 530, dpHeaLoa_nominal = 460, hea(TRefLoa = 30 + 273.15, TRefSou = 0 + 273.15, Q_flow = 5850.00, P = 1270, mSou_flow = 1000 / 3600, mLoa_flow = 1040 / 3600, coeQ = {-4.31, -2.8, 8.17, 0.00, 0.00}, coeP = {-8.66, 6.75, 2.94, 0.00, 0.00}), coo(TRefSou = 28 + 273.15, TRefLoa = 12 + 273.15, Q_flow = -5560.00, P = 1424.44, coeQ = {-5.79235417, 9.83800467, -3.19795605, 0.0, 0.0}, coeP = {-6.37109639, 1.27560526, 5.81780490, 0.0, 0.0})) "First selected heat pump" annotation(
