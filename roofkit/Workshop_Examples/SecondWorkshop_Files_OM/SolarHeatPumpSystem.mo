...
model SolarHeatPumpSystem
  "Example for a heat pump system and solar thermal collector at the source side, with the ISO 13790 building model"
  ...
  Buildings.Fluid.HeatPumps.EquationFitReversible heaPum(
    ...
    annotation (Placement(transformation(extent={{-50,-34},{2,16}})));
  Modelica.Blocks.Sources.IntegerConstant integerMode(k = 1) annotation (
    Placement(transformation(extent={{-112,-16},{-86,10}})));
  parameter
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus" annotation (
    Placement(transformation(extent={{84,98},{104,118}}),      iconTransformation(extent={{84,98},
            {104,118}})));
  Modelica.Blocks.Logical.Hysteresis hysSollCircuit(
    pre_y_start=true,
    uLow=273.15 + 6,
    uHigh=273.15 + 10)
    annotation (Placement(transformation(extent={{-86,-124},{-104,-106}})));
...
equation
  ...
  connect(integerMode.y, heaPum.uMod) annotation (
    Line(points={{-84.7,-3},{-68,-3},{-68,-9},{-52.6,-9}},              color = {255, 127, 0}));
  ...
  connect(heaPum.TSet, TSetHP.y) annotation (
    Line(points={{-53.64,13.5},{-62,13.5},{-62,36},{-87,36}},       color = {0, 0, 127}));
  ...
  connect(pipeSC.port_b, solTh_Return_T.port_b)
    annotation (Line(points={{-54,-88},{-54,-106}}, color={0,127,255}));
  ...
  connect(pipeSC.port_a, heaPum.port_b2) annotation (Line(points={{-54,-68},{
          -54,-46},{-54,-24},{-50,-24}}, color={0,127,255}));
...
connect(heaPum.port_a2, thermalCollector.port_b) annotation (
  ...
  connect(hysSollCircuit.y, not2.u) annotation (Line(points={{-104.9,-115},{
          -122,-115},{-122,-116},{-140,-116},{-140,-139},{-131.8,-139}},
        color={255,0,255}));
  connect(hysSollCircuit.u, solTh_Return_T.T) annotation (Line(points={{-84.2,
          -115},{-74.1,-115},{-74.1,-116},{-65,-116}}, color={0,0,127}));
  connect(not2.y, booleanToReal.u) annotation (Line(points={{-111.1,-139},{
          -100.55,-139},{-100.55,-150},{-90,-150}}, color={255,0,255}));
  annotation (
    Diagram(coordinateSystem(preserveAspectRatio=false,   extent={{-160,-170},
            {160,170}}),                                                                        graphics={  Rectangle(origin={-2,
              124},                                                                                                                      fillColor = {170, 170, 127},
            fillPattern =                                                                                                                                                           FillPattern.Solid, extent={{
              -126,38},{126,-38}}),                                                                                                                                                                                                        Text(origin={
              -27,148},                                                                                                                                                                                                        extent = {{-53, 22}, {53, -22}}, textString = "Gebäude und Wetter"), Rectangle(origin={2,
              15},                                                                                                                                                                                                        fillColor = {255, 147, 147},
            fillPattern =                                                                                                                                                                                                        FillPattern.Solid, extent={{
              130,-69},{-130,69}}),                                                                                                                                                                                                        Text(origin={89,
              -22},                                                                                                                                                                                                        extent = {{-39, 34}, {39, -34}}, textString = "Wärmepumpe
Heizkörper
Vorlauftemp 50°C
      "),
        Rectangle(origin = {2, -109}, fillColor = {213, 255, 170},
...
<p>
  ...
  <li>
    ...
    Icon(coordinateSystem(extent={{-160,-170},{160,170}}, preserveAspectRatio=
           false),                                              graphics={  Ellipse(lineColor = {75, 138, 73}, fillColor = {255, 255, 255},
