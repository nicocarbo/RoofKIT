within RoofKIT.Workshop_Examples.Examples_copied_otherLibs;
model SolarThermalCollector_MFS
  "Example to demonstrate the function of the solar thermal collector model with mass flow source"
...
equation
  connect(massFlowSensor.port_b, T1.port_a)
    annotation (Line(points={{-38,0},{-28,0}}, color={0,127,255}));
  ...
  connect(boundary.ports[1], massFlowSensor.port_a)
    annotation (Line(points={{-70,0},{-58,0}}, color={0,127,255}));
  annotation (
    experiment(StopTime=86400, Interval=600, __Dymola_Algorithm="Dassl"),
