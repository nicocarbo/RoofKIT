...
model Trial_IdealHeating_NightVent
  ...
  Buildings.Fluid.HeatExchangers.Heater_T heater_T(redeclare package Medium =
        Buildings.Media.Water,                                                                       QMax_flow = 1000, T_start = 299.15, dp_nominal = 10, energyDynamics = Modelica.Fluid.Types.Dynamics.FixedInitial, m_flow_nominal = 1000/4200/10) annotation (
  ...
  Buildings.Fluid.Movers.FlowControlled_m_flow mov(redeclare package Medium =
        Buildings.Media.Water,                                                                       addPowerToMedium = false, energyDynamics = Modelica.Fluid.Types.Dynamics.SteadyState, m_flow_nominal = 50*1000/3600) annotation (
    Placement(visible = true, transformation(extent = {{-124, -98}, {-104, -78}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant mFan_flow(k = 50/3600) annotation (
    Placement(visible = true, transformation(extent = {{-164, -60}, {-144, -40}}, rotation = 0)));
  Buildings.Fluid.Sources.Boundary_pT bou_wat( redeclare package Medium =
        Buildings.Media.Water,                                                                   nPorts=1) annotation (
    Placement(visible = true, transformation(origin = {-152, -88}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Buildings.Fluid.HeatExchangers.Radiators.RadiatorEN442_2 rad(redeclare
      package Medium =
        Buildings.Media.Water,                                                                                   Q_flow_nominal = 1000, T_a_nominal = 273.15 + 50, T_b_nominal = 273.15 + 40, energyDynamics = Modelica.Fluid.Types.Dynamics.FixedInitial) annotation (
    Placement(visible = true, transformation(extent = {{-44, -60}, {-24, -40}}, rotation = 0)));
  ...
  Buildings.Controls.Continuous.LimPID conPI(Ti = 120, controllerType = Modelica.Blocks.Types.SimpleController.PI, k = 1, yMax = 10000, yMin = 0) annotation (
    Placement(visible = true, transformation(origin = {-118, -22}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant TSetP(k = 273.15 + 21) annotation (
    Placement(visible = true, transformation(extent = {{-162, -12}, {-142, 8}}, rotation = 0)));
  Buildings.Fluid.Sources.Boundary_pT bou_air(redeclare package Medium =
        Modelica.Media.Air.SimpleAir,                                                                  nPorts = 2, use_T_in = true) annotation (
    Placement(visible = true, transformation(origin = {148, 10}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  Buildings.Fluid.Movers.FlowControlled_m_flow Supply_fan(redeclare package
      Medium =
        Modelica.Media.Air.SimpleAir,                                                                              addPowerToMedium = false, m_flow_nominal = 80*1000 / 3600) annotation (
    Placement(visible = true, transformation(origin = {102, 12}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  Buildings.Fluid.Movers.FlowControlled_m_flow Exhaust_fan(redeclare package
      Medium =
        Modelica.Media.Air.SimpleAir,                                                                               addPowerToMedium = false, m_flow_nominal = 80*1000 / 3600) annotation (
    Placement(visible = true, transformation(origin = {102, -24}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
  Modelica.Blocks.Logical.LessThreshold lessThreshold_TAir(threshold = 290) annotation (
    Placement(visible = true, transformation(origin = {34, -122}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Blocks.Sources.Constant massflow_true(k = 200*1000 / 3600) annotation (
    Placement(visible = true, transformation(extent = {{58, -80}, {78, -60}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant massflow_false(k = 0) annotation (
    Placement(visible = true, transformation(extent = {{58, -144}, {78, -124}}, rotation = 0)));
  Modelica.Blocks.Logical.Hysteresis hysPum(uHigh = 300, uLow = 297) annotation (
    Placement(visible = true, transformation(extent = {{24, -96}, {44, -76}}, rotation = 0)));
equation
  ...
  connect(heater_T.port_a, mov.port_b) annotation (
    Line(points = {{-80, -50}, {-92, -50}, {-92, -88}, {-104, -88}}, color = {0, 127, 255}));
  connect(mFan_flow.y, mov.m_flow_in) annotation (
    Line(points = {{-143, -50}, {-114, -50}, {-114, -76}}, color = {0, 0, 127}));
  connect(bou_wat.ports[1], mov.port_a) annotation (
    Line(points = {{-142, -88}, {-124, -88}}, color = {0, 127, 255}));
  connect(heater_T.port_b, rad.port_a) annotation (
    Line(points = {{-60, -50}, {-44, -50}}, color = {0, 127, 255}));
  connect(rad.port_b, mov.port_a) annotation (
    Line(points = {{-24, -50}, {-14, -50}, {-14, -110}, {-126, -110}, {-126, -88}, {-124, -88}}, color = {0, 127, 255}));
  connect(rad.heatPortCon, thermalZoneOneElement.intGainsConv) annotation (
    Line(points={{-36,-42.8},{-36,38},{40,38},{40,120}},        color = {191, 0, 0}));
  connect(rad.heatPortRad, thermalZoneOneElement.intGainsRad) annotation (
    Line(points={{-32,-42.8},{-32,44},{50,44},{50,124},{40,124}},          color = {191, 0, 0}));
  connect(TRoom.port, thermalZoneOneElement.intGainsConv) annotation (
    Line(points = {{-68, -2}, {46, -2}, {46, 120}, {40, 120}}, color = {191, 0, 0}));
  connect(conPI.u_s, TSetP.y) annotation (
    Line(points = {{-130, -22}, {-136.5, -22}, {-136.5, -2}, {-141, -2}}, color = {0, 0, 127}));
  connect(conPI.u_m, TRoom.T) annotation (
    Line(points = {{-118, -10}, {-119, -10}, {-119, -2}, {-88, -2}}, color = {0, 0, 127}));
  connect(conPI.y, heater_T.TSet) annotation (
    Line(points = {{-107, -22}, {-92, -22}, {-92, -42}, {-82, -42}}, color = {0, 0, 127}));
  connect(bou_air.T_in, weaBus.TDryBul) annotation (
    Line(points={{160,14},{172,14},{172,42},{-135,42},{-135,106}},            color = {0, 0, 127}));
  connect(lessThreshold_TAir.y, and1.u2) annotation (
    Line(points={{45,-122},{49,-122},{49,-112},{56,-112}},          color = {255, 0, 255}));
  connect(massflow_true.y, switch1.u1) annotation (
    Line(points = {{79, -70}, {92, -70}, {92, -96}}, color = {0, 0, 127}));
  connect(massflow_false.y, switch1.u3) annotation (
    Line(points = {{79, -134}, {92, -134}, {92, -112}}, color = {0, 0, 127}));
  connect(and1.y, switch1.u2) annotation (
    Line(points = {{79, -104}, {92, -104}}, color = {255, 0, 255}));
  connect(switch1.y, Exhaust_fan.m_flow_in) annotation (
    Line(points = {{115, -104}, {186, -104}, {186, -42}, {102, -42}, {102, -36}}, color = {0, 0, 127}));
  connect(Supply_fan.m_flow_in, switch1.y) annotation (
    Line(points = {{102, 24}, {102, 34}, {186, 34}, {186, -104}, {115, -104}}, color = {0, 0, 127}));
  connect(bou_air.ports[1], Supply_fan.port_a) annotation (
    Line(points={{138,12},{112,12},{112,12}},        color = {0, 127, 255}));
  connect(Exhaust_fan.port_b, bou_air.ports[2]) annotation (
    Line(points={{112,-24},{138,-24},{138,8}},         color = {0, 127, 255}));
  connect(weaBus.TDryBul, lessThreshold_TAir.u) annotation (
    Line(points={{-135,106},{-136,106},{-136,48},{10,48},{10,-122},{22,-122}},              color = {0, 0, 127}));
  connect(Supply_fan.port_b, thermalZoneOneElement.ports[1]) annotation (
    Line(points={{92,12},{42,12},{42,98.05},{29.475,98.05}},color = {0, 127, 255}));
  connect(Exhaust_fan.port_a, thermalZoneOneElement.ports[2]) annotation (
    Line(points={{92,-24},{32.525,-24},{32.525,98.05}},
                                                    color = {0, 127, 255}));
  connect(and1.u1, hysPum.y) annotation (
    Line(points={{56,-104},{45,-104},{45,-86}},        color = {255, 0, 255}));
  connect(hysPum.u, TRoom.T) annotation (
    Line(points = {{22, -86}, {16, -86}, {16, -18}, {-88, -18}, {-88, -2}}, color = {0, 0, 127}));
  annotation (
 ...
 Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow</a>
  ...
  Implemented.
    ...
    Diagram(coordinateSystem(extent = {{-200, -200}, {200, 200}}), graphics={  Rectangle(origin = {10, 121}, fillColor = {170, 170, 127},
            fillPattern =                                                                                                                               FillPattern.Solid, extent = {{-182, 71}, {182, -71}}), Text(origin = {131, 70}, extent = {{-53, 22}, {53, -22}}, textString = "Gebäude und Wetter"), Rectangle(origin = {-88.4, -67.89}, fillColor = {255, 147, 147},
            fillPattern =                                                                                                                                                                                                        FillPattern.Solid, extent = {{83.6, -103.89}, {-83.6, 103.89}}), Text(origin = {-86, -157}, extent = {{-68, 37}, {68, -37}}, textString = "Ideale Heizung (Sollwert 21°C)"), Rectangle(origin = {98.6, -67.89}, fillColor = {85, 170, 255},
            fillPattern =                                                                                                                                                                                                        FillPattern.Solid, extent = {{94.6, -103.89}, {-94.6, 103.89}}), Text(origin = {157, -142}, extent = {{-31, 6}, {31, -6}}, textString = "Nachtlüftung"), Rectangle(origin = {62, -108.69}, fillColor = {85, 85, 255},
            fillPattern =                                                                                                                                                                                                        FillPattern.Solid, extent = {{-56, -60.69}, {56, 60.69}}), Text(origin = {58, -162}, extent = {{-34, 6}, {34, -6}}, textString = "Regelung")}),
    Icon(coordinateSystem(extent = {{-200, -200}, {200, 200}})));
end Trial_IdealHeating_NightVent;
