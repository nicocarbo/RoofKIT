...
model HDU_PufferSourceOnly_noTime
  ...
  BuildingSystems.Technologies.ThermalStorages.FluidStorage TWW(redeclare package Medium = Medium_loa, redeclare package Medium_HX_1 = Medium_loa, redeclare package Medium_HX_2 = Medium_loa, HX_1 = true, HX_2 = false, T_start = 70 + 273.15, UA_HX_1 = 20000, V = 0.185, nEle = 5) annotation(
  ...
  BuildingSystems.Technologies.ThermalStorages.FluidStorage Quelle_Puffer(redeclare package Medium = Medium_sou, redeclare package Medium_HX_1 = Medium_sou, redeclare package Medium_HX_2 = Medium_sou, HX_1 = true, HX_2 = false, T_start = 15 + 273.15, UA_HX_1 = 20000, UA_HX_2 = 2000, V = 0.2, nEle = 5, thickness_ins = 0.1) annotation(
...
//Connections
  ...
  connect(add5.u1, booleanToReal.y) annotation(
    Line(points = {{-114, 22}, {-154, 22}, {-154, 50}, {-218, 50}, {-218, 64}}, color = {0, 0, 127}));
  ...
  connect(add5.y, val11.y) annotation(
    Line(points = {{-104, 26}, {62, 26}, {62, 12}}, color = {0, 0, 127}));
