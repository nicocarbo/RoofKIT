...
model HDU_PufferDouble
  ...
  parameter Modelica.SIunits.MassFlowRate mLoa_flow_nominal = 0.2778 "Load heat exchanger nominal mass flow rate";
  ...
  Modelica.Blocks.Logical.Hysteresis hysteresis6(uHigh = 4 + 273.15, uLow = 0 + 273.15) annotation(
    Placement(visible = true, transformation(origin = {-69, -111}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ...
  Modelica.Blocks.Math.BooleanToReal booleanToReal5 annotation(
    Placement(visible = true, transformation(origin = {-34, -108}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
  Modelica.Thermal.HeatTransfer.Sources.PrescribedHeatFlow prescribedHeatFlow1 annotation(
    Placement(visible = true, transformation(origin = {9, -101}, extent = {{-3, -3}, {3, 3}}, rotation = 0)));
  Modelica.Blocks.Logical.Not not2 annotation(
    Placement(visible = true, transformation(origin = {-51, -109}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant constant1(k = 1500) annotation(
    Placement(visible = true, transformation(origin = {-34, -118}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
  ...
  Modelica.Blocks.Math.Max max annotation(
    Placement(visible = true, transformation(origin = {79, -174}, extent = {{7, -7}, {-7, 7}}, rotation = 0)));
  Modelica.Blocks.Continuous.Integrator integrator_WP_Th annotation(
    Placement(visible = true, transformation(origin = {118, -128}, extent = {{6, -6}, {-6, 6}}, rotation = 0)));
  Modelica.Blocks.Math.Division JAZ annotation(
    Placement(visible = true, transformation(origin = {71, -145}, extent = {{7, -7}, {-7, 7}}, rotation = 0)));
  ...
  Modelica.Blocks.Continuous.Integrator integrator_Heizstab annotation(
    Placement(visible = true, transformation(origin = {34, -168}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant constant3(k = 50) annotation(
    Placement(visible = true, transformation(origin = {110, -178}, extent = {{4, -4}, {-4, 4}}, rotation = 0)));
  Modelica.Blocks.Math.Add add8 annotation(
    Placement(visible = true, transformation(origin = {99, -145}, extent = {{5, 5}, {-5, -5}}, rotation = 0)));
...
//Connections
  ...
  connect(prescribedHeatFlow.Q_flow, product3.y) annotation(
    Line(points = {{6, -71}, {-2, -71}, {-2, -142}, {-4, -142}}, color = {0, 0, 127}));
  ...
  connect(temperatureTwoPort.T, hysteresis6.u) annotation(
    Line(points = {{4, -88}, {4, -98}, {-74, -98}, {-74, -110}}, color = {0, 0, 127}));
  connect(hysteresis6.y, not2.u) annotation(
    Line(points = {{-64, -110}, {-56, -110}, {-56, -108}}, color = {255, 0, 255}));
  connect(not2.y, booleanToReal5.u) annotation(
    Line(points = {{-46, -108}, {-38, -108}}, color = {255, 0, 255}));
  connect(booleanToReal5.y, product4.u2) annotation(
    Line(points = {{-30, -108}, {-15, -108}, {-15, -110}}, color = {0, 0, 127}));
  connect(constant1.y, product4.u1) annotation(
    Line(points = {{-30, -118}, {-15, -118}, {-15, -114}}, color = {0, 0, 127}));
  connect(prescribedHeatFlow1.Q_flow, product4.y) annotation(
    Line(points = {{6, -101}, {0, -101}, {0, -112}, {-6, -112}}, color = {0, 0, 127}));
  connect(prescribedHeatFlow1.port, vol.heatPort) annotation(
    Line(points = {{12, -100}, {18, -100}, {18, -78}}, color = {191, 0, 0}));
  connect(constant3.y, max.u2) annotation(
    Line(points = {{106, -178}, {88, -178}}, color = {0, 0, 127}));
  connect(JAZ.u2, max.y) annotation(
    Line(points = {{80, -150}, {84, -150}, {84, -158}, {68, -158}, {68, -174}, {72, -174}}, color = {0, 0, 127}));
  connect(product4.y, integrator_Heizstab.u) annotation(
    Line(points = {{-6, -112}, {14, -112}, {14, -168}, {27, -168}}, color = {0, 0, 127}));
  connect(add8.y, max.u1) annotation(
    Line(points = {{94, -144}, {92, -144}, {92, -170}, {88, -170}}, color = {0, 0, 127}));
  connect(integrator_WP_Th.y, JAZ.u1) annotation(
    Line(points = {{111, -128}, {84, -128}, {84, -140}, {80, -140}}, color = {0, 0, 127}));
  connect(integrator_WP_Th.u, limiter1.y) annotation(
    Line(points = {{126, -128}, {136, -128}}, color = {0, 0, 127}));
  connect(integrator_WP_El.u, limiter.y) annotation(
    Line(points = {{155.2, -148}, {165.2, -148}}, color = {0, 0, 127}));
  connect(add8.u2, integrator_WP_El.y) annotation(
    Line(points = {{106, -142}, {142, -142}, {142, -148}}, color = {0, 0, 127}));
  connect(integrator_Heizstab.y, add8.u1) annotation(
    Line(points = {{40, -168}, {44, -168}, {44, -190}, {120, -190}, {120, -148}, {106, -148}}, color = {0, 0, 127}));
  connect(limiter1.u, heaPum.QLoa_flow) annotation(
    Line(points = {{150, -128}, {158, -128}, {158, 0}, {-8, 0}}, color = {0, 0, 127}));
