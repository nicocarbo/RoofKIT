...
model HDU_Thermal
  ...
  Modelica.Blocks.Logical.Hysteresis hyst_TWW(uHigh = 46 + 273.15, uLow = 40 + 273.15) annotation(
  ...
  Buildings.Fluid.MixingVolumes.MixingVolume mixingVolume(redeclare package Medium = Medium_loa, T_start = 35 + 273.15, V = 0.18, m_flow_nominal = mSou_flow_nominal, nPorts = 3) annotation(
  ...
  Modelica.Blocks.Sources.Constant Tset_TWW(k = 273.15 + 48) annotation(
  ...
  Modelica.Blocks.Logical.GreaterThreshold gre_TWW(threshold = 14) annotation(
...
//Connections
  ...
  connect(teeJunctionIdeal.port_2, TWW.port_HX_2_b) annotation(
    Line(points = {{-68, 13}, {-74, 13}, {-74, 28}, {-38, 28}, {-38, 97}, {-41, 97}}, color = {0, 127, 255}));
  ...
  connect(pump_HP_TWW.port_b, TWW.port_HX_2_a) annotation(
    Line(points = {{-30, 100}, {-35, 100}, {-35, 99}, {-41, 99}}, color = {0, 127, 255}));
