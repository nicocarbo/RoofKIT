...
import Modelica.Constants.*;
  ...
  RoofKIT.Components.Solar.Thermal.ThermalCollector thermalCollector(redeclare package Medium = Medium_sou, A_coll = 44.8, Eta_zero = 0.554, T_start = 10 + 273.15, capColl = 0, dp_nominal(displayUnit = "Pa") = 50, m_flow_nominal = 0.3, volSol = 0.04312) annotation(
  ...
  Modelica.Blocks.Sources.Constant const6(k = -4000) annotation(
    Placement(visible = true, transformation(origin = {-32, -146}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
  Modelica.Blocks.Logical.Hysteresis hysteresis2(uHigh = 90 + 273.15, uLow = 70 + 273.15) annotation(
    Placement(visible = true, transformation(origin = {-67, -139}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  Modelica.Blocks.Math.BooleanToReal booleanToReal1 annotation(
    Placement(visible = true, transformation(origin = {-32, -136}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
  Modelica.Blocks.Math.Product product3 annotation(
    Placement(visible = true, transformation(origin = {-8, -142}, extent = {{-4, 4}, {4, -4}}, rotation = 0)));
  Buildings.Fluid.Actuators.Valves.TwoWayLinear val3(redeclare package Medium = Medium_sou, dpValve_nominal = 6000, m_flow_nominal = mSou_flow_nominal, riseTime = 10) annotation(
    Placement(visible = true, transformation(origin = {-46, -72}, extent = {{4, -4}, {-4, 4}}, rotation = 90)));
  Buildings.Fluid.Actuators.Valves.TwoWayLinear val4(redeclare package Medium = Medium_sou, dpValve_nominal = 6000, m_flow_nominal = mSou_flow_nominal, riseTime = 10) annotation(
    Placement(visible = true, transformation(origin = {78, -70}, extent = {{4, 4}, {-4, -4}}, rotation = 90)));
  Buildings.Fluid.Actuators.Valves.TwoWayLinear val6(redeclare package Medium = Medium_sou, dpValve_nominal = 6000, m_flow_nominal = mSou_flow_nominal, riseTime = 10) annotation(
    Placement(visible = true, transformation(origin = {78, -92}, extent = {{4, 4}, {-4, -4}}, rotation = 90)));
  Modelica.Blocks.Math.Add add3(k1 = -1) annotation(
    Placement(visible = true, transformation(origin = {-133, -105}, extent = {{-5, 5}, {5, -5}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant const2(k = 1) annotation(
    Placement(visible = true, transformation(origin = {-158, -98}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
  Modelica.Fluid.Fittings.TeeJunctionIdeal T_TWW2(redeclare package Medium = Medium_sou) annotation(
    Placement(visible = true, transformation(origin = {78, -82}, extent = {{-4, 4}, {4, -4}}, rotation = -90)));
  Modelica.Fluid.Fittings.TeeJunctionIdeal T_TWW1(redeclare package Medium = Medium_sou) annotation(
    Placement(visible = true, transformation(origin = {-46, -82}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
  Buildings.Fluid.Actuators.Valves.TwoWayLinear val5(redeclare package Medium = Medium_sou, dpValve_nominal = 6000, m_flow_nominal = mSou_flow_nominal, riseTime = 10) annotation(
    Placement(visible = true, transformation(origin = {-56, -82}, extent = {{4, -4}, {-4, 4}}, rotation = 180)));
  ...
  Modelica.Blocks.Logical.Hysteresis hysteresis3(uHigh = 3, uLow = 1) annotation(
    Placement(visible = true, transformation(origin = {-185, -123}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  Modelica.Blocks.Math.Add add4(k2 = -1) annotation(
    Placement(visible = true, transformation(origin = {-203, -123}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  Modelica.Blocks.Math.BooleanToReal booleanToReal2 annotation(
    Placement(visible = true, transformation(origin = {-163, -123}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ...
  BuildingSystems.Technologies.ThermalStorages.FluidStorage Quelle_Puffer(redeclare package Medium = Medium_sou, redeclare package Medium_HX_1 = Medium_sou, redeclare package Medium_HX_2 = Medium_sou, HX_1 = true, HX_2 = false, T_start = 20 + 273.15, UA_HX_1 = 20000, UA_HX_2 = 2000, V = 0.1, nEle = 5) annotation(
...
Modelica.Blocks.Sources.Constant const3(k = 1) annotation(
    Placement(visible = true, transformation(origin = {180, -66}, extent = {{4, -4}, {-4, 4}}, rotation = 0)));
equation
//Connections
...
connect(booleanToReal1.y, product3.u2) annotation(
    Line(points = {{-27.6, -136}, {-20.1, -136}, {-20.1, -140}, {-12.6, -140}}, color = {0, 0, 127}));
connect(const6.y, product3.u1) annotation(
    Line(points = {{-27.6, -146}, {-18.1, -146}, {-18.1, -144}, {-12.6, -144}}, color = {0, 0, 127}));
...
connect(T_TWW2.port_2, val6.port_a) annotation(
    Line(points = {{78, -86}, {78, -88}}, color = {0, 127, 255}));
connect(val4.port_b, T_TWW2.port_1) annotation(
    Line(points = {{78, -74}, {78, -78}}, color = {0, 127, 255}));
connect(STemp_sou1.port_a, T_TWW2.port_3) annotation(
    Line(points = {{74, -82}, {74, -82}}, color = {0, 127, 255}));
...
connect(const2.y, add3.u2) annotation(
    Line(points = {{-153.6, -98}, {-145.1, -98}, {-145.1, -102}, {-138.6, -102}}, color = {0, 0, 127}));
connect(STemp_sou1.T, hysteresis2.u) annotation(
    Line(points = {{67, -89}, {67, -130.6}, {-77, -130.6}, {-77, -138.6}, {-73, -138.6}}, color = {0, 0, 127}));
...
connect(val3.port_b, T_TWW1.port_3) annotation(
    Line(points = {{-46, -76}, {-46, -78}}, color = {0, 127, 255}));
connect(T_TWW1.port_2, pump_sou.port_a) annotation(
    Line(points = {{-42, -82}, {-26, -82}}, color = {0, 127, 255}));
connect(val5.port_b, T_TWW1.port_1) annotation(
    Line(points = {{-52, -82}, {-50, -82}}, color = {0, 127, 255}));
...
connect(TWW.T[1], add4.u2) annotation(
    Line(points = {{-50, 62}, {-48, 62}, {-48, 36}, {-236, 36}, {-236, -126}, {-209, -126}}, color = {0, 0, 127}));
connect(add4.y, hysteresis3.u) annotation(
    Line(points = {{-197.5, -123}, {-191, -123}}, color = {0, 0, 127}));
connect(val5.y, booleanToReal2.y) annotation(
    Line(points = {{-56, -86.8}, {-56, -122.8}, {-157.5, -122.8}}, color = {0, 0, 127}));
connect(val6.y, booleanToReal2.y) annotation(
    Line(points = {{82.8, -92}, {95.8, -92}, {95.8, -123}, {-157.7, -123}}, color = {0, 0, 127}));
connect(add3.y, val3.y) annotation(
    Line(points = {{-127.5, -105}, {-118, -105}, {-118, -72}, {-51, -72}}, color = {0, 0, 127}));
connect(hysteresis3.y, booleanToReal2.u) annotation(
    Line(points = {{-179.5, -123}, {-169, -123}}, color = {255, 0, 255}));
connect(booleanToReal2.y, add3.u1) annotation(
    Line(points = {{-157.5, -123}, {-148, -123}, {-148, -108}, {-139, -108}}, color = {0, 0, 127}));
...
connect(vol.ports[2], pump_sou.port_b) annotation(
    Line(points = {{21, -82}, {-14, -82}}, color = {0, 127, 255}));
...
connect(hysteresis3.y, not12.u) annotation(
    Line(points = {{-179.5, -123}, {-174, -123}, {-174, -24}, {-149, -24}}, color = {255, 0, 255}));
...
connect(val4.y, add3.y) annotation(
    Line(points = {{83, -70}, {92.8, -70}, {92.8, -106}, {-113.2, -106}, {-113.2, -105}, {-126.7, -105}}, color = {0, 0, 127}));
connect(const.y, pump_sou.m_flow_in) annotation(
    Line(points = {{-151.6, -76}, {-119.6, -76}, {-119.6, -66}, {-20, -66}, {-20, -75}}, color = {0, 0, 127}));
connect(hysteresis2.y, booleanToReal1.u) annotation(
    Line(points = {{-61.5, -139}, {-49.5, -139}, {-49.5, -136}, {-37, -136}}, color = {255, 0, 255}));
...
connect(prescribedHeatFlow.Q_flow, product3.y) annotation(
    Line(points = {{6, -77}, {-2, -77}, {-2, -142}, {-4, -142}}, color = {0, 0, 127}));
connect(val6.port_b, TWW.port_HX_1_a) annotation(
    Line(points = {{78, -96}, {-72, -96}, {-72, 52}, {-64, 52}}, color = {0, 127, 255}));
connect(val5.port_a, TWW.port_HX_1_b) annotation(
    Line(points = {{-60, -82}, {-70, -82}, {-70, 50}, {-64, 50}}, color = {0, 127, 255}));
...
connect(val3.port_a, T_QP1.port_2) annotation(
    Line(points = {{-46, -68}, {-46, -62}}, color = {0, 127, 255}));
connect(T_QP1.port_1, Quelle_Puffer.port_HX_1_b) annotation(
    Line(points = {{-46, -58}, {-46, -56}, {2, -56}, {2, -48}, {-2, -48}}, color = {0, 127, 255}));
connect(T_QP2.port_1, val4.port_a) annotation(
    Line(points = {{42, -42}, {78, -42}, {78, -66}}, color = {0, 127, 255}));
...
connect(add4.u1, STemp_sou1.T) annotation(
    Line(points = {{-208, -120}, {-212, -120}, {-212, -114}, {67, -114}, {67, -89}}, color = {0, 0, 127}));
...
connect(booleanToReal4.y, val7.y) annotation(
    Line(points = {{170, -38}, {184, -38}, {184, -50}, {20, -50}, {20, -46}}, color = {0, 0, 127}));
connect(add7.u1, booleanToReal4.y) annotation(
    Line(points = {{156, -60}, {184, -60}, {184, -38}, {170, -38}}, color = {0, 0, 127}));
