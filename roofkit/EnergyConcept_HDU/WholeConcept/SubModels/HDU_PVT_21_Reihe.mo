...
extends Modelica.Icons.Example;
  ...
  RoofKIT.Components.Solar.Thermal.ThermalCollector thermalCollector(redeclare package Medium = Medium_sou, A_coll = 33.6, Eta_zero = 0.554, T_start = 10 + 273.15, capColl = 0, dp_nominal(displayUnit = "Pa") = 50, m_flow_nominal = 0.3, volSol = 0.03234) annotation(
  ...
  Modelica.Blocks.Sources.Constant const6(k = -2000) annotation(
