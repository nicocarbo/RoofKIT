...
import Modelica.Constants.*;
  ...
  BuildingSystems.Technologies.ThermalStorages.FluidStorage Pufferspeicher(redeclare package Medium = Medium_loa, redeclare package Medium_HX_1 = Medium_loa, redeclare package Medium_HX_2 = Medium_loa, Ele_HX_2 = 4, HX_1 = false, HX_2 = true, UA_HX_2 = 2000, V = 0.3, height = 1.5, nEle = 5) annotation(
  ...
  Modelica.Blocks.Sources.Constant const6(k = -4000) annotation(
    Placement(visible = true, transformation(origin = {-32, -118}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
  Modelica.Blocks.Logical.Hysteresis hysteresis2(uHigh = 90 + 273.15, uLow = 70 + 273.15) annotation(
    Placement(visible = true, transformation(origin = {-67, -111}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ...
  Modelica.Blocks.Math.Product product3 annotation(
    Placement(visible = true, transformation(origin = {-8, -114}, extent = {{-4, 4}, {4, -4}}, rotation = 0)));
  Buildings.Fluid.Actuators.Valves.TwoWayLinear val3(redeclare package Medium = Medium_sou, dpValve_nominal = 6000, m_flow_nominal = mSou_flow_nominal, riseTime = 10) annotation(
    Placement(visible = true, transformation(origin = {-46, -44}, extent = {{4, -4}, {-4, 4}}, rotation = 90)));
  ...
  Modelica.Blocks.Math.Add add3(k1 = -1) annotation(
    Placement(visible = true, transformation(origin = {-133, -73}, extent = {{-5, 5}, {5, -5}}, rotation = 0)));
  ...
  Buildings.Fluid.Actuators.Valves.TwoWayLinear val5(redeclare package Medium = Medium_sou, dpValve_nominal = 6000, m_flow_nominal = mSou_flow_nominal, riseTime = 10) annotation(
    Placement(visible = true, transformation(origin = {-56, -54}, extent = {{4, -4}, {-4, 4}}, rotation = 180)));
  ...
  Buildings.Fluid.MixingVolumes.MixingVolume vol(redeclare package Medium = Medium_sou, V = 0.0003, m_flow_nominal = mSou_flow_nominal, nPorts = 2) annotation(
    Placement(visible = true, transformation(origin = {21, -51}, extent = {{-3, -3}, {3, 3}}, rotation = 0)));
  ...
  Modelica.Thermal.HeatTransfer.Sources.PrescribedHeatFlow prescribedHeatFlow annotation(
    Placement(visible = true, transformation(origin = {9, -49}, extent = {{-3, -3}, {3, 3}}, rotation = 0)));
equation
//Connections
  ...
  connect(booleanToReal1.y, product3.u2) annotation(
    Line(points = {{-28, -108}, {-20.5, -108}, {-20.5, -112}, {-13, -112}}, color = {0, 0, 127}));
  connect(const6.y, product3.u1) annotation(
    Line(points = {{-28, -118}, {-18.5, -118}, {-18.5, -116}, {-13, -116}}, color = {0, 0, 127}));
  ...
  connect(heaPum.port_b2, val3.port_a) annotation(
    Line(points = {{-38, -16}, {-46, -16}, {-46, -40}}, color = {0, 127, 255}));
  connect(bou_sou.ports[1], pump_sou.port_a) annotation(
    Line(points = {{-36, -68}, {-34, -68}, {-34, -54}, {-30, -54}}, color = {0, 127, 255}));
  connect(const2.y, add3.u2) annotation(
    Line(points = {{-154, -70}, {-139, -70}}, color = {0, 0, 127}));
  connect(STemp_sou1.T, hysteresis2.u) annotation(
    Line(points = {{63, -61}, {63, -103}, {-77, -103}, {-77, -111}, {-73, -111}}, color = {0, 0, 127}));
  ...
  connect(val3.port_b, T_TWW1.port_3) annotation(
    Line(points = {{-46, -48}, {-46, -50}}, color = {0, 127, 255}));
  connect(T_TWW1.port_2, pump_sou.port_a) annotation(
    Line(points = {{-42, -54}, {-30, -54}}, color = {0, 127, 255}));
  connect(val5.port_b, T_TWW1.port_1) annotation(
    Line(points = {{-52, -54}, {-50, -54}}, color = {0, 127, 255}));
  connect(val5.port_a, TWW.port_HX_1_b) annotation(
    Line(points = {{-60, -54}, {-70, -54}, {-70, 50}, {-64, 50}}, color = {0, 127, 255}));
  connect(val6.port_b, TWW.port_HX_1_a) annotation(
    Line(points = {{78, -68}, {78, -74}, {-72, -74}, {-72, 52}, {-64, 52}}, color = {0, 127, 255}));
  ...
  connect(STemp_sou1.T, add4.u1) annotation(
    Line(points = {{63, -61}, {42, -61}, {42, -86}, {-228, -86}, {-228, -92}, {-209, -92}}, color = {0, 0, 127}));
  ...
  connect(val5.y, booleanToReal2.y) annotation(
    Line(points = {{-56, -59}, {-56, -95}, {-157.5, -95}}, color = {0, 0, 127}));
  ...
  connect(add3.y, val3.y) annotation(
    Line(points = {{-127.5, -73}, {-118, -73}, {-118, -44}, {-51, -44}}, color = {0, 0, 127}));
  ...
  connect(booleanToReal2.y, add3.u1) annotation(
    Line(points = {{-157.5, -95}, {-148, -95}, {-148, -76}, {-139, -76}}, color = {0, 0, 127}));
  connect(vol.ports[1], thermalCollector.port_a) annotation(
    Line(points = {{21, -54}, {32, -54}}, color = {0, 127, 255}));
  connect(vol.ports[2], pump_sou.port_b) annotation(
    Line(points = {{21, -54}, {-18, -54}}, color = {0, 127, 255}));
  ...
  connect(val4.y, add3.y) annotation(
    Line(points = {{82, -44}, {92, -44}, {92, -78}, {-114, -78}, {-114, -72}, {-128, -72}}, color = {0, 0, 127}));
  connect(const.y, pump_sou.m_flow_in) annotation(
    Line(points = {{-152, -48}, {-120, -48}, {-120, -38}, {-24, -38}, {-24, -46}}, color = {0, 0, 127}));
  connect(hysteresis2.y, booleanToReal1.u) annotation(
    Line(points = {{-61.5, -111}, {-49.5, -111}, {-49.5, -108}, {-37, -108}}, color = {255, 0, 255}));
  connect(prescribedHeatFlow.port, vol.heatPort) annotation(
    Line(points = {{12, -49}, {16, -49}, {16, -50}, {18, -50}}, color = {191, 0, 0}));
  connect(prescribedHeatFlow.Q_flow, product3.y) annotation(
    Line(points = {{6, -49}, {-2, -49}, {-2, -114}, {-4, -114}}, color = {0, 0, 127}));
  annotation(
