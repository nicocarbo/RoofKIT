...
import Modelica.Constants.*;
  ...
  package Medium_sou = Buildings.Media.Antifreeze.PropyleneGlycolWater(X_a = 0.50, property_T = 283.15);
  ...
  Buildings.Fluid.Sources.Boundary_pT bou_sou(redeclare package Medium = Medium_sou, nPorts = 1, use_T_in = false) annotation(
    Placement(visible = true, transformation(origin = {-30, -54}, extent = {{4, -4}, {-4, 4}}, rotation = 0)));
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort STemp_sou2(redeclare package Medium = Medium_sou, m_flow_nominal = mSou_flow_nominal) annotation(
    Placement(visible = true, transformation(origin = {-42, -54}, extent = {{-6, -4}, {6, 4}}, rotation = 180)));
  ...
  Buildings.Fluid.Actuators.Valves.TwoWayLinear val3(redeclare package Medium = Medium_sou, dpValve_nominal = 6000, m_flow_nominal = mSou_flow_nominal, riseTime = 10) annotation(
    Placement(visible = true, transformation(origin = {-54, -44}, extent = {{4, -4}, {-4, 4}}, rotation = 90)));
  Buildings.Fluid.Actuators.Valves.TwoWayLinear val4(redeclare package Medium = Medium_sou, dpValve_nominal = 6000, m_flow_nominal = mSou_flow_nominal, riseTime = 10) annotation(
    Placement(visible = true, transformation(origin = {78, -44}, extent = {{4, 4}, {-4, -4}}, rotation = 90)));
  Buildings.Fluid.Actuators.Valves.TwoWayLinear val6(redeclare package Medium = Medium_sou, dpValve_nominal = 6000, m_flow_nominal = mSou_flow_nominal, riseTime = 10) annotation(
    Placement(visible = true, transformation(origin = {78, -64}, extent = {{4, 4}, {-4, -4}}, rotation = 90)));
  Modelica.Blocks.Math.Add add3(k1 = -1) annotation(
    Placement(visible = true, transformation(origin = {-132, -78}, extent = {{-4, 4}, {4, -4}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant const2(k = 1) annotation(
    Placement(visible = true, transformation(origin = {-158, -76}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
  Modelica.Fluid.Fittings.TeeJunctionIdeal T_TWW2(redeclare package Medium = Medium_sou) annotation(
    Placement(visible = true, transformation(origin = {78, -54}, extent = {{-4, 4}, {4, -4}}, rotation = -90)));
  Modelica.Fluid.Fittings.TeeJunctionIdeal T_TWW1(redeclare package Medium = Medium_sou) annotation(
    Placement(visible = true, transformation(origin = {-54, -54}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
  Buildings.Fluid.Actuators.Valves.TwoWayLinear val5(redeclare package Medium = Medium_sou, dpValve_nominal = 6000, m_flow_nominal = mSou_flow_nominal, riseTime = 10) annotation(
    Placement(visible = true, transformation(origin = {-64, -54}, extent = {{4, -4}, {-4, 4}}, rotation = 180)));
  BuildingSystems.Technologies.ThermalStorages.FluidStorage TWW(redeclare package Medium = Medium_heat, redeclare package Medium_HX_1 = Medium_sou, redeclare package Medium_HX_2 = Medium_loa, HX_1 = true, HX_2 = false, T_start = 43 + 273.15, UA_HX_1 = 20000, UA_HX_2 = 2000, V = 0.185, nEle = 5) annotation(
  ...
  Modelica.Blocks.Logical.Hysteresis hysteresis3(uHigh = 3, uLow = 1) annotation(
    Placement(visible = true, transformation(origin = {-184, -96}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
  ...
  Buildings.Fluid.Sources.Boundary_pT bou_amb(redeclare package Medium = Medium_sou, nPorts = 1, use_T_in = true) annotation(
    Placement(visible = true, transformation(origin = {-14, -54}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
  ...
  Modelica.Blocks.Logical.Switch switch1 annotation(
    Placement(visible = true, transformation(origin = {-95, -63}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  Modelica.Blocks.Logical.GreaterEqual greaterEqual annotation(
    Placement(visible = true, transformation(origin = {-127, -59}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant const3(k = 0.2956) annotation(
    Placement(visible = true, transformation(origin = {22, -46}, extent = {{4, -4}, {-4, 4}}, rotation = 0)));
  Buildings.Fluid.Movers.FlowControlled_m_flow pump_sou2(redeclare replaceable package Medium = Medium_sou, energyDynamics = Modelica.Fluid.Types.Dynamics.SteadyState, m_flow_nominal = mSou_flow_nominal, nominalValuesDefineDefaultPressureCurve = true, use_inputFilter = false, y_start = 1) annotation(
    Placement(visible = true, transformation(origin = {-23, -40}, extent = {{-5, -4}, {5, 4}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant const4(k = mLoa_flow_nominal - 0.2956) annotation(
...
connect(add.y, hysteresis1.u) annotation(
  ...
  connect(heaPum.port_a2, val4.port_a) annotation(
    Line(points = {{-10, -16}, {78, -16}, {78, -40}}, color = {0, 127, 255}));
  connect(T_TWW2.port_2, val6.port_a) annotation(
    Line(points = {{78, -58}, {78, -60}}, color = {0, 127, 255}));
  connect(val4.port_b, T_TWW2.port_1) annotation(
    Line(points = {{78, -48}, {78, -50}}, color = {0, 127, 255}));
  connect(STemp_sou1.port_a, T_TWW2.port_3) annotation(
    Line(points = {{70, -54}, {74, -54}}, color = {0, 127, 255}));
  connect(const2.y, add3.u2) annotation(
    Line(points = {{-154, -76}, {-137, -76}}, color = {0, 0, 127}));
  ...
  connect(val3.port_b, T_TWW1.port_3) annotation(
    Line(points = {{-54, -48}, {-54, -50}}, color = {0, 127, 255}));
  connect(val5.port_b, T_TWW1.port_1) annotation(
    Line(points = {{-60, -54}, {-58, -54}}, color = {0, 127, 255}));
  connect(val5.port_a, TWW.port_HX_1_b) annotation(
    Line(points = {{-68, -54}, {-70, -54}, {-70, 50}, {-64, 50}}, color = {0, 127, 255}));
  connect(val6.port_b, TWW.port_HX_1_a) annotation(
    Line(points = {{78, -68}, {78, -72}, {-72, -72}, {-72, 52}, {-64, 52}}, color = {0, 127, 255}));
  ...
  connect(STemp_sou1.T, add4.u1) annotation(
    Line(points = {{63, -61}, {62, -61}, {62, -86}, {-228, -86}, {-228, -92}, {-209, -92}}, color = {0, 0, 127}));
...
connect(add4.y, hysteresis3.u) annotation(
    Line(points = {{-197.5, -95}, {-194.25, -95}, {-194.25, -96}, {-191, -96}}, color = {0, 0, 127}));
  connect(val5.y, booleanToReal2.y) annotation(
    Line(points = {{-64, -59}, {-64, -95}, {-157.5, -95}}, color = {0, 0, 127}));
  connect(val6.y, booleanToReal2.y) annotation(
    Line(points = {{83, -64}, {96, -64}, {96, -95}, {-157.5, -95}}, color = {0, 0, 127}));
  connect(add3.y, val3.y) annotation(
    Line(points = {{-128, -78}, {-118, -78}, {-118, -44}, {-59, -44}}, color = {0, 0, 127}));
connect(hysteresis3.y, booleanToReal2.u) annotation(
    Line(points = {{-177, -96}, {-174.25, -96}, {-174.25, -95}, {-169, -95}}, color = {255, 0, 255}));
...
connect(hysteresis1.y, or1.u2) annotation(
    Line(points = {{-157, -14}, {-154.25, -14}, {-154.25, -15}, {-151, -15}}, color = {255, 0, 255}));
...
connect(hysteresis3.y, not12.u) annotation(
    Line(points = {{-177, -96}, {-174, -96}, {-174, -24}, {-149, -24}}, color = {255, 0, 255}));
  ...
  connect(product1.y, pump_loa.m_flow_in) annotation(
    Line(points = {{-125.5, -37}, {-121.75, -37}, {-121.75, -33}, {46, -33}, {46, -12}}, color = {0, 0, 127}));
  connect(val4.y, add3.y) annotation(
    Line(points = {{82, -44}, {92, -44}, {92, -78}, {-128, -78}}, color = {0, 0, 127}));
  connect(bou_amb.ports[1], pump_sou.port_a) annotation(
    Line(points = {{-10, -54}, {-6, -54}}, color = {0, 127, 255}));
  connect(switch1.y, bou_amb.T_in) annotation(
    Line(points = {{-89.5, -63}, {-22, -63}, {-22, -52}, {-19, -52}}, color = {0, 0, 127}));
  connect(T_TWW1.port_2, STemp_sou2.port_b) annotation(
    Line(points = {{-50, -54}, {-48, -54}}, color = {0, 127, 255}));
  connect(STemp_sou2.port_a, bou_sou.ports[1]) annotation(
    Line(points = {{-36, -54}, {-34, -54}}, color = {0, 127, 255}));
  connect(STemp_sou2.T, switch1.u1) annotation(
    Line(points = {{-42, -58}, {-42, -62}, {-88, -62}, {-88, -54}, {-106, -54}, {-106, -58}, {-100, -58}}, color = {0, 0, 127}));
  connect(weaBus.TDryBul, switch1.u3) annotation(
    Line(points = {{-194, 140}, {-194, 94}, {-242, 94}, {-242, -66}, {-100, -66}}, color = {0, 0, 127}));
  connect(heaPum.port_b2, val3.port_a) annotation(
    Line(points = {{-38, -16}, {-54, -16}, {-54, -40}}, color = {0, 127, 255}));
  connect(STemp_sou2.T, greaterEqual.u1) annotation(
    Line(points = {{-42, -58}, {-42, -62}, {-88, -62}, {-88, -54}, {-140, -54}, {-140, -59}, {-133, -59}}, color = {0, 0, 127}));
  connect(greaterEqual.y, switch1.u2) annotation(
    Line(points = {{-121.5, -59}, {-110, -59}, {-110, -62}, {-100, -62}}, color = {255, 0, 255}));
  connect(weaBus.TDryBul, greaterEqual.u2) annotation(
    Line(points = {{-194, 140}, {-194, 94}, {-242, 94}, {-242, -63}, {-133, -63}}, color = {0, 0, 127}));
  ...
  connect(const3.y, pump_sou.m_flow_in) annotation(
    Line(points = {{18, -46}, {0, -46}}, color = {0, 0, 127}));
  connect(heaPum.port_b2, pump_sou2.port_a) annotation(
    Line(points = {{-38, -16}, {-38, -40}, {-28, -40}}, color = {0, 127, 255}));
  connect(pump_sou2.port_b, heaPum.port_a2) annotation(
    Line(points = {{-18, -40}, {-10, -40}, {-10, -16}}, color = {0, 127, 255}));
  connect(const4.y, pump_sou2.m_flow_in) annotation(
    Line(points = {{10, -22}, {-6, -22}, {-6, -35}, {-23, -35}}, color = {0, 0, 127}));
  annotation(
    Diagram(graphics = {Rectangle(origin = {9, 115}, fillColor = {170, 170, 127}, fillPattern = FillPattern.Solid, extent = {{-91, 23}, {91, -23}}), Rectangle(origin = {-47, 61}, fillColor = {170, 213, 255}, fillPattern = FillPattern.Solid, extent = {{35, -29}, {-35, 29}}), Rectangle(origin = {45, 61}, fillColor = {255, 121, 161}, fillPattern = FillPattern.Solid, extent = {{55, -29}, {-55, 29}}), Rectangle(origin = {9, 2}, fillColor = {255, 147, 147}, fillPattern = FillPattern.Solid, extent = {{91, -28}, {-91, 28}}), Rectangle(origin = {-166, 6}, fillColor = {181, 181, 181}, fillPattern = FillPattern.Solid, extent = {{-82, 132}, {82, -132}}), Rectangle(origin = {9, -64}, fillColor = {62, 186, 91}, fillPattern = FillPattern.Solid, extent = {{91, -36}, {-91, 36}}), Rectangle(origin = {-111, 61}, fillColor = {169, 255, 169}, fillPattern = FillPattern.Solid, extent = {{27, -29}, {-27, 29}}), Rectangle(origin = {157, 32}, fillColor = {181, 181, 181}, fillPattern = FillPattern.Solid, extent = {{-55, 58}, {55, -58}})}),
