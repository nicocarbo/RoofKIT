...
model HeatPumpSystem_WW "Example for a heat pump system with the ISO 13790 building model"
...
equation
  ...
  annotation (
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-160, -160}, {160, 160}}), graphics = {Rectangle(origin = {4, 104}, fillColor = {170, 170, 127}, fillPattern = FillPattern.Solid, extent = {{-154, 54}, {154, -54}}), Text(origin = {-13, 136}, extent = {{-53, 22}, {53, -22}}, textString = "Gebäude und Wetter"), Rectangle(origin = {2, -57}, fillColor = {255, 147, 147}, fillPattern = FillPattern.Solid, extent = {{156, -97}, {-156, 97}}), Text(origin = {-113, 18}, extent = {{-39, 34}, {39, -34}}, textString = "Wärmepumpe
Heizkörper
Vorlauftemp 40°C")}),
