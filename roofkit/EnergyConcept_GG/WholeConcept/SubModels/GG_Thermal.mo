...
model GG_Thermal
  ...
  Buildings.Fluid.Sources.MassFlowSource_T Vent_SUP(redeclare package Medium = Buildings.Media.Air, nPorts = 1, use_T_in = true, use_m_flow_in = true) annotation(
...
equation
 ...
 connect(WaterTank.port_HX_1_b, WW_tank.ports[2]) annotation(
  ...
  connect(realExpression4.y, prescribedHeatFlow.Q_flow) annotation(
    Line(points = {{-300, -125}, {-292, -125}}, color = {0, 0, 127}));
