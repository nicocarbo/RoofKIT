...
model Thermal_System
  ...
  //  TRANSYS
  //
  Modelica.Blocks.Sources.CombiTimeTable FirstFloor(fileName = "C:\Users\49157\Documents\01_RED\RoofKIT\RoofKIT\RoofKIT-Vers1\Inputs\FirstFloor.txt", table = [0, 0, 0, 0, 0, 0], tableName = "FirstFloor", tableOnFile = true) annotation(
    Placement(visible = true, transformation(origin = {-341, 129}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  Modelica.Blocks.Sources.CombiTimeTable SecondFloor(fileName = "C:\Users\49157\Documents\01_RED\RoofKIT\RoofKIT\RoofKIT-Vers1\Inputs\SecondFloor.txt", table = [0, 0, 0, 0, 0, 0], tableName = "SecondFloor", tableOnFile = true) annotation(
    Placement(visible = true, transformation(origin = {-319, 129}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  Modelica.Blocks.Sources.CombiTimeTable ThirdFloor(fileName = "C:\Users\49157\Documents\01_RED\RoofKIT\RoofKIT\RoofKIT-Vers1\Inputs\ThirdFloor.txt", table = [0, 0, 0, 0, 0, 0], tableName = "ThirdFloor", tableOnFile = true) annotation(
...
than room temperature in thrid floor 
 -> heat exchange"), Rectangle(origin = {27, 155}, fillColor = {0, 255, 0}, fillPattern = FillPattern.Solid, extent = {{-9, 7}, {9, -7}}), Rectangle(origin = {56, 76}, fillColor = {0, 255, 0}, fillPattern = FillPattern.Solid, extent = {{-28, 6}, {28, -6}}), Rectangle(origin = {-67, 15}, fillColor = {0, 255, 0}, fillPattern = FillPattern.Solid, extent = {{-9, 7}, {9, -7}}), Rectangle(origin = {27, 135}, fillColor = {0, 255, 0}, fillPattern = FillPattern.Solid, extent = {{-9, 7}, {9, -7}}), Rectangle(origin = {-217, -99}, fillColor = {0, 255, 0}, fillPattern = FillPattern.Solid, extent = {{-9, 7}, {9, -7}}), Rectangle(origin = {-269, -146}, fillColor = {0, 255, 0}, fillPattern = FillPattern.Solid, extent = {{-25, 14}, {25, -14}}), Text(origin = {-155, -185}, extent = {{-111, 5}, {111, -5}}, textString = "Temperaturunterschied zwischen Zapftemperatur und WasteWater Temperatur"), Rectangle(origin = {51, -112}, fillColor = {0, 255, 0}, fillPattern = FillPattern.Solid, extent = {{-19, 6}, {19, -6}}), Rectangle(origin = {56, 76}, fillColor = {0, 255, 0}, fillPattern = FillPattern.Solid, extent = {{-28, 6}, {28, -6}}), Rectangle(origin = {56, 76}, fillColor = {0, 255, 0}, fillPattern = FillPattern.Solid, extent = {{-28, 6}, {28, -6}}), Rectangle(origin = {56, 76}, fillColor = {0, 255, 0}, fillPattern = FillPattern.Solid, extent = {{-28, 6}, {28, -6}}), Rectangle(origin = {64, -96}, fillColor = {0, 255, 0}, fillPattern = FillPattern.Solid, extent = {{-28, 6}, {28, -6}}), Text(origin = {100, -73}, extent = {{-98, 31}, {98, -31}}, textString = "Set Temperatur, eingestellt nach konstanter Leistung 
